                    ...
                    {question.options.map((option) => {
                      ...
                      return (
                        <div
                          ...
                          className={`relative rounded-lg border px-4 py-3 cursor-pointer ${isSelected ? 'border-primary bg-primary-50' : 'border-gray-300'} ${showCorrect ? 'border-green-500 bg-green-50' : ''} ${showIncorrect ? 'border-red-500 bg-red-50' : ''} ${isAnswered ? 'cursor-default' : 'hover:border-primary'}`}
                        >
